...
This is a **demo-only topology**, separate from the production images (the
backend and an nginx frontend as two containers with a real LLM, built and
published by [`cd.yml`](../.github/workflows/cd.yml)). Nothing here changes that.
